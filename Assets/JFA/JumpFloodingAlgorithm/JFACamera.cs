...
namespace Seiro.GPUSandbox.JFA
{
    public class JFACamera : MonoBehaviour
    {
        ...
        private void InitRT()
        {
            ...
            // JFAの作業用のバッファは解像度を下げておいても特に問題ない。
            RenderTextureDescriptor descJFAWork;
            ConstructCommonRTDescriptor(out descJFAWork);
            ...
            _jfaFillBufs[0] = RenderTexture.GetTemporary(descJFAWork);
            _jfaFillBufs[0].name = "jfa temp 0";
            _jfaFillBufs[0].filterMode = FilterMode.Point;

            _jfaFillBufs[1] = RenderTexture.GetTemporary(descJFAWork);
            ...
            _distanceFieldBuf = RenderTexture.GetTemporary(descJFAWork);
        ...
        {
            UtilFunc.ReleaseRT(ref _jfaSeedBuf);
            UtilFunc.ReleaseRT(ref _jfaFillBufs[0]);
            UtilFunc.ReleaseRT(ref _jfaFillBufs[1]);
            UtilFunc.ReleaseRT(ref _lightingBuf);
            UtilFunc.ReleaseRT(ref _distanceFieldBuf);
        }
